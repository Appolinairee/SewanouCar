...
const Categories = ({ProductsData, handleProducts, initialProducts}) => {
  ...
  useEffect(() => {
    ...
    const allCategories = ["Tout", "Plus cher", "Moins cher", ...new Set(ProductsData.map(product => product.category))];
    ...
    ProductsData.forEach(product => {
      initialProductsCountByCategory[product.category]++;
    });
    setProductsCountByCategory(initialProductsCountByCategory);
  ...
  function handleCategoryChange(category) {
    ...
    if(category == "Tout" || category=="Plus cher" || category=="Moins cher"){
      handleProducts(initialProducts);
    } else{
