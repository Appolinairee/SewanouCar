...
const Contact = () => {
  return (
    <section className="contact">
        ...
        <div className="contactInfos top-0 !relative !w-full !right-0">
            
            <div className="contactElements relative before !top-10 transform-none m-auto right-0 max-w-[500px]">
                <h2>Informations</h2>
